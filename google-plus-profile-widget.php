<?php
/* 
Plugin Name: G+ Profile Widget (Boost your SEO)
Description: Boost your SEO and SEO optimise your website even further with this Google+ profile widget!
Version: 1.0
Author: spyrosli
*/

add_action('widgets_init', 'bcn_googleplus_load_widgets');

function bcn_googleplus_load_widgets()
{
	register_widget('bcn_googleplus_Widget');
}

class bcn_googleplus_Widget extends WP_Widget {
	
	function __construct()
	{
		$widget_ops = array('classname' => 'bcn_googleplus', 'description' => __('Adds a Google+ profile widget.','new-google-plus-badge-widget'));

		$control_ops = array('id_base' => 'google-badge-box');

		parent::__construct('google-badge-box', __('Google Plus Profile Widget','new-google-plus-badge-widget'), $widget_ops, $control_ops);
	}
	...
	{
		$defaults = array('title' => __('Google Plus','new-google-plus-badge-widget'), 'page_url' => '', 'width' => '300', 'color_scheme' => 'light', 'gp_layout' => 'portrait', 'page_type' => 'profile', 'cover_photo' => true, 'tagline' => true);
		...
		<p>
			<label for="<?php echo $this->get_field_id('color_scheme'); ?>"><?php _e('Design','new-google-plus-badge-widget'); ?>:</label> 
